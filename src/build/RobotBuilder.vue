...
<script>
//import availableParts from "../data/parts"; used before actions
...
export default {
  ...
  beforeRouteLeave(to, from, next){
    if(this.addedToCart){
      ...
      const response = confirm('You have not added ' + 
      'your robot to your cart, are you sure you want to leave?');
      next(response);
    }
  },
  ...
  data() {
    return {
      //availableParts, used to be to read from parts.js
      addedToCart: false,
      cart: [],
      selectedRobot: {
        head: {},
